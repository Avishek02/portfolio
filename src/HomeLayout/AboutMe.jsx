        ...
        <section id="about-section" className="relative pb-10" ref={ref}>
            <div data-aos="zoom-in-down" className="relative max-w-6xl mx-auto px-6 text-center mb-12">
                <h2 className="text-4xl md:text-5xl font-extrabold bg-linear-to-r from-emerald-500 to-lime-400 bg-clip-text text-transparent shimmer">
                    Modern Web Builder                </h2>
                <div data-aos="zoom-in" className="w-60 md:w-110 h-1 mx-auto mt-2 bg-lime-500 rounded-full"></div>
            </div>
            ...
            <div className="relative max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12">
                    ...
                    <div
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-gray-400 leading-relaxed text-sm md:text-base">
                                A dedicated and results-driven 𝐅𝐮𝐥𝐥-𝐒𝐭𝐚𝐜𝐤 Web Developer. I specialize in building modern, scalable web applications using the 𝐌𝐄𝐑𝐍 𝐬𝐭𝐚𝐜𝐤. I thrive on turning complex problems into elegant, user-friendly digital solutions.
                                Beyond just coding, I focus on writing 𝐜𝐥𝐞𝐚𝐧, 𝐦𝐚𝐢𝐧𝐭𝐚𝐢𝐧𝐚𝐛𝐥𝐞, 𝐚𝐧𝐝 𝐢𝐧𝐝𝐮𝐬𝐭𝐫𝐲-𝐬𝐭𝐚𝐧𝐝𝐚𝐫𝐝 𝐜𝐨𝐝𝐞 to ensure long-term scalability. My expertise includes architecting 𝐫𝐨𝐛𝐮𝐬𝐭 𝐑𝐄𝐒𝐓𝐟𝐮𝐥 𝐀𝐏𝐈𝐬, and optimizing 𝐝𝐚𝐭𝐚𝐛𝐚𝐬𝐞 𝐩𝐞𝐫𝐟𝐨𝐫𝐦𝐚𝐧𝐜𝐞 for seamless user experiences. I am always eager to embrace new challenges and stay updated with the latest trends.
                            </p>
                ...
                <div data-aos="fade-left">
                    ...
                    >
                        ...
                        <p className="text-gray-400 leading-relaxed text-sm md:text-base ">
                            My core focus is on delivering 𝐡𝐢𝐠𝐡-𝐩𝐞𝐫𝐟𝐨𝐫𝐦𝐚𝐧𝐜𝐞 𝐝𝐢𝐠𝐢𝐭𝐚𝐥 𝐩𝐫𝐨𝐝𝐮𝐜𝐭𝐬 that solve actual business challenges. I specialize in building 𝐬𝐜𝐚𝐥𝐚𝐛𝐥𝐞 𝐚𝐫𝐜𝐡𝐢𝐭𝐞𝐜𝐭𝐮𝐫𝐞𝐬 that ensure long-term stability while maintaining a seamless, 𝐮𝐬𝐞𝐫-𝐜𝐞𝐧𝐭𝐫𝐢𝐜 𝐞𝐱𝐩𝐞𝐫𝐢𝐞𝐧𝐜𝐞.
                        </p>
