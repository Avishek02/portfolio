            ...
            <div className="relative max-w-7xl mx-auto px-6 py-14 md:py-24 grid md:grid-cols-2 gap-12 items-center">
                ...
                <div data-aos="fade-right">
                    ...
                    <div className="flex gap-10 pt-8 pl-2 text-3xl text-white cursor-pointer">
                        <a href="https://github.com/Avishek02">
                            <FaGithub className="
                        ...
                        <a href="https://www.linkedin.com/in/avishek-tanchangya/">
                        ...
                        <a href="https://mail.google.com/mail/?view=cm&fs=1&to=avishek2390@gmail.com">
                            <SiGmail className="
                                          bg-none fill-current
                                          transition-transform duration-300
                                          hover:scale-[1.3] hover:text-lime-300
                ...
                <div data-aos="fade-left" className="relative">
                    <div>
                        <h2 className="text-4xl md:text-6xl absolute left-8 top-40 font-bold text-white z-10 animate-floatSlow font-name2 animate-glow">
                            Web <span className="text-[#22c55e]">Developer</span>
                        </h2>
                    </div>
                    ...
                    <img
                        src={hero_logo}
                        alt="profile"
                        className="relative z-20 mx-auto md:h-100 animate-fadeIn"
                        style={{
