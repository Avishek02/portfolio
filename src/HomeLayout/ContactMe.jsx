          ...
          <div
            ...
            <div>
              ...
              <p className="text-gray-300 mb-6">
                {inView && (
                  <Typewriter
                    words={["I am always eager to collaborate on innovative projects and explore opportunities where I can contribute to your vision. Whether you have a specific idea in mind or just want to discuss potential synergies, my door is always open."]}
                    loop={1}
                    cursor
                    cursorStyle=""
                    typeSpeed={8}
              ...
              >
                ...
                <p className="flex items-center gap-2 transition-transform duration-500 ease-in-out hover:translate-x-2 text-gray-400 hover:text-lime-500">
                  <FaLocationArrow className="text-lime-500" />
                  Opent to work on Remote | On-site | Hybrid
                </p>
              </div>
            </div>
