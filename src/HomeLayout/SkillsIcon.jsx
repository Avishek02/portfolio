...
const icons = [
    ...
    { icon: <FaNodeJs size={orbitIconSize} color="#4DB33D" />, radiusX: 150, radiusY: 120, duration: 15 },
...
const SkillsIcon = () => {
    return (
        ...
        :mt-40 overflow-hidden lg:overflow-visible">
            ...
            <div>
                <div className="absolute md:-top-22 left-1/2 -translate-x-1/2 z-10 text-center w-full">
                    ...
                    <div data-aos="zoom-in" className="w-70 md:w-150 h-1 mx-auto mt-3 bg-lime-500 rounded-full"></div>
                </div>
